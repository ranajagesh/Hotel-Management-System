...
public class UpdateRoom extends JFrame implements ActionListener {
    ...
    UpdateRoom() {
        ...
        tfavailable.setBounds(230,180,150,25);
        add(tfavailable);
        
        JLabel lbclean = new JLabel("Cleaning Status");
        lbclean.setBounds(30,230,100,20);
        add(lbclean);
    ...
    public void actionPerformed(ActionEvent ae) {
       ...
       try {
           ...
           try {
               Conn c = new Conn();
                c.s.executeUpdate("update customer set availability = '"+available+"', cleaning_status = '"+status+"' where roomno = '"+room+"'");
